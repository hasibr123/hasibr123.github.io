...
bananas out known to man." key="twdesc" />
      ...
      <div >
          <div className="flex items-center justify-between w-full border-b-2	pb-6">
            ...
            <nav className="items-center Poppitandfinchsans">
              <a href="/#about" className="text-4xl text-white hover:text-black m-6">VAULT</a>
        ...
        <div className="md:w-2/3 w-4/5">
          ...
          <div className="mt-6 border-b-2 py-6">
            ...
            <div className="flex flex-col items-center">
                ...
                <span className="flex montserrat text-5xl text-white items-center bg-grey-lighter rounded rounded-r-none my-4 ">TOTAL VAULTS MINTED:  <span className="text-blau text-6xl"> {!signedIn ?  <>-</>  :  <>{totalSupply}</> } / 101</span></span>

                <div id="mint" className="flex justify-around  mt-8 mx-6">
                  <span className="flex montserrat text-5xl text-white items-center bg-grey-lighter rounded rounded-r-none px-3 font-bold">I Want</span>
                  ...
                  <span className="flex montserrat text-5xl text-white items-center bg-grey-lighter rounded rounded-r-none px-3 font-bold">Pieces</span>
                ...
                <button onClick={() => mintBanana(how_many_bananas)} className="mt-4 Poppitandfinchsans text-4xl border-6 bg-blau  text-white hover:text-black p-2 ">MINT {how_many_bananas} bananas for {(bananaPrice * how_many_bananas) / (10 ** 18)} ETH + GAS</button>        
                  : <button className="mt-4 montserrat text-4xl border-6 bg-blau  text-white hover:text-black p-2 ">SALE IS NOT ACTIVE OR NO WALLET IS CONNECTED</button>        
